...
# File Paths (Defaults for Deployment)
default_network_path = "elec_s_100_ec_lcopt_Co2L-1h_144h_2030_0.071_AB_0export.nc"
...
default_solar_profile = "profile_solar.nc"
default_wind_profile = "profile_onwind.nc"
    ...
    if n.generators_t.p.empty:
        ...
        if total_gen.empty:
            ...
            try:
                ...
                store_demand = store_flow.clip(upper=0)
